...
import { Input } from "@hackyard/ui/components/input";
import { Textarea } from "@hackyard/ui/components/textarea";
...
function InputGroup({ className, ...props }: react.ComponentProps<"div">) {
  return (
    <div
      className={cn(
        "group/input-group relative flex w-full items-center rounded-full border border-input shadow-xs outline-none transition-[color,box-shadow] dark:bg-input/30",
...
function InputGroupInput({
  ...
  return (
    <Input
      className={cn(
        "flex-1 rounded-full border-0 bg-transparent shadow-none placeholder:font-medium focus-visible:ring-0 dark:bg-transparent",
        className,
      )}
