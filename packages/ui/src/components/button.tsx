  ...
  "inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-full font-semibold text-base outline-none transition-all duration-200 ease-in-out focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    ...
    variants: {
      ...
      variant: {
        ...
        primary:
          "bg-primary text-primary-foreground shadow-xs hover:bg-gray-700 focus-visible:ring-primary/20 dark:hover:bg-gray-200",
        "primary-ghost":
          "bg-accent text-accent-foreground hover:bg-gray-100 focus-visible:ring-primary/20 dark:hover:bg-gray-900",
        "primary-link":
          "text-accent-foreground hover:text-gray-800 hover:underline focus-visible:ring-primary/20 dark:hover:text-gray-200",
        "primary-outline":
          "border border-border text-accent-foreground hover:border-gray-600 focus-visible:ring-transparent dark:hover:border-gray-600",
        secondary:
